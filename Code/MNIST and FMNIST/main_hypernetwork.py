...
class HyperLinearLayer(nn.Module):
    def __init__(self, hyper_input_dim, target_input_dim, target_output_dim):
        ...
        self.hypernetwork = Hypernetwork(hyper_input_dim, 0, target_input_dim * target_output_dim)
    ...
    def forward(self, x, hyper_input):
        ...
        weights = self.hypernetwork(hyper_input)
        ...
        bias = None  # You can include a generated bias if needed
        output = nn.functional.linear(x, weights, bias)  # Linear transformation
        return output
