...
if __name__ == "__main__":
    ...
    net = Net_vanilla_CNN_normal(input_channels,layers,kernels,use_bn=use_bn,dropping=dropping)
    
    
    net_GMU = Net_vanilla_CNN_convert(input_channels,layers,kernels,use_bn=use_bn,dropping=dropping)
    
    
    net_GMU.load_state_dict(torch.load('Best_CNN_convert_FashionMNIST_[3, 8]degree_400epochs_[25, 50]layers60000data.h5',weights_only=True))
