# -*- coding: utf-8 -*-
"""
Created on Mon May 12 16:07:45 2025
...
#     @torch.compile
    ...
    def load_pretrained_weights(self, pretrained_weights):
        """ Initialize GMU weights with pretrained ResNet-50 conv1 weights """
        with torch.no_grad():
            # Copy weights from ResNet-50 conv1 (ignoring num_slices dimension)
            self.weights[:, :, :, :, 0] = pretrained_weights
...
# resnet18.conv1 = GMULayer(3, 64, 7, padding=3, epsilon=0.0001, num_slices=3, degree=1)
