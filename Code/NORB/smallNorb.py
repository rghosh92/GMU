...
class NORB(data.Dataset):
    ...
    dataset_root = "https://cs.nyu.edu/~yann/data/norb-v1.0/"
    data_files = {
        
        'test': {
            'dat': {
                "name": 'norb-5x01235x9x18x6x2x108x108-testing-02-dat.mat',
                "md5_gz": "e4ad715691ed5a3a5f138751a4ceb071",
                "md5": "e9920b7f7b2869a8f1a12e945b2c166c"
            },
            'info': {
                "name": 'norb-5x01235x9x18x6x2x108x108-testing-02-info.mat',
                "md5_gz": "a9454f3864d7fd4bb3ea7fc3eb84924e",
                "md5": "7c5b871cc69dcadec1bf6a18141f5edc"
            },
            'cat': {
                "name": 'norb-5x01235x9x18x6x2x108x108-testing-02-cat.mat',
...
#         self.labels = self.labels.cuda() 
    ...
    def _load(self, file_name):
        full_path = os.path.join(self.root, self.processed_folder, file_name + self.extension)
...
#         download and extract
        for file_dict in self._flat_data_files():
            ...
            download_url(url, os.path.join(self.root, self.raw_folder), gz_filename)
