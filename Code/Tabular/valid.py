...
if __name__ == "__main__":
    ...
    train_normal = [] 
    trials = 1
    names = [233088,233090,233091,	233093,	233094,	233096,	233103,	233108,	233109,	233115,	233116,
             233117,233134,	233135,		233099,	233107,	233110,	233119,	233124,	233122,	233112,
             233114,	233120,	233102,	233106,	233142,	233104]
